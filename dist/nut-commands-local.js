...
class Runner {
    ...
    async runCommandList(cmds) {
        try {
            for (var cmds_1 = __asyncValues(cmds), cmds_1_1; cmds_1_1 = await cmds_1.next(), !cmds_1_1.done;) {
                let cmd = await cmds_1_1.value;
            ...
            try {
                if (cmds_1_1 && !cmds_1_1.done && (_a = cmds_1.return)) await _a.call(cmds_1);
            }
