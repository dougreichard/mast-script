            ...
            if (currIndentLevel > lastIndentLevel && type === "indent") {
                ...
                if (indentStack.length > 2) {
                    ...
                    while (indentStack.length > 2 &&
                        ...
                        indentStack.pop();
                        matchedTokens.push(createTokenInstance(allLex.Outdent, "", NaN, NaN, NaN, NaN, NaN, NaN));
                    }
                }
                indentStack.pop();
                return match;
...
module.exports = {
    ...
    tokenize: function (text) {
        ...
        while (indentStack.length > 1) {
            lexResult.tokens.push(createTokenInstance(allLex.Outdent, "", NaN, NaN, NaN, NaN, NaN, NaN));
            indentStack.pop();
        }
        return lexResult;
    }
